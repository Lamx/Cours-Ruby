class Personne
  ...
  def info
    ...
    return nom + " : #{points_de_vie}/100" if en_vie == true
    # - Renvoie le nom et "vaincu" si la personne a été vaincue
    return nom + " : vaincu" if en_vie == false
  end
...
class Jeu
  ...
  def self.est_fini(joueur, monde)
    ...
    if joueur.points_de_vie = 0 || monde.ennemis.points_de_vie == 0
    return true
    end
  end
end
